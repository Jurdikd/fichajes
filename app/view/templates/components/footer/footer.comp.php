...
?>
<footer id="footer" class=" b-0 bg-dark copyright">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <p>XLI JUEGOS DEPORTIVOS NACIONALES INTERCOLEGIOS DE ABOGADOS DE VENEZUELA CARABOBO 2024</p>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <ul class="bottom_ul footer-ul bg-dark" dir="ltr">
                    <li>
                        <span class="text-white">Programador: Copyright © 2023 / 2024</span> <a href="https://api.whatsapp.com/send?phone=584245649007&text=Hola,%20%C2%BFQu%C3%A9%20tal%20est%C3%A1s?%20Quisiera%20contratar%20los%20servicios%20de%20programaci%C3%B3n" target="_blank" rel="noopener noreferrer"><i class="fab fa-whatsapp"></i> JESUS A. COVO GARRIDO</a>
