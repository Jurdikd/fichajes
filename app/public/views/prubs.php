...
if (existeTabla($tabla)) {
    ...
    try {
        ...
        echo "La tabla $tabla se ha eliminado correctamente.";
    } catch (PDOException $ex) {
        echo "Error al eliminar la tabla $tabla: " . $ex->getMessage();
    }
} else {
...
# Función para verificar la existencia de una tabla en la base de datos
function existeTabla($tabla)
{
    try {
        $sql = "SELECT 1 FROM $tabla LIMIT 1";
