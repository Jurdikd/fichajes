        ...
        <div class="col-12 col-sm-5 col-md-5 col-lg-3">
            <div class="card shadow-ficha text-tiro" id="userFicha">
                <div class="card-body">
                    ...
                    <img id="preview" class="card-img-top card-img-cover rounded filterFichaje2" src="<?php echo RUTA_IMG; ?>users/prub.JPG" alt="" srcset="" width="300" height="300" loading="lazy">
