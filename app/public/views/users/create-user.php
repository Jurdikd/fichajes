...
if (intval($user["id_rol"]) !== 1 && intval($user["id_rol"]) !== 4) {
    # code...
        ...
        <div class="col-12 col-sm-7 col-md-7 col-lg-9">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-tittle mb-4">Formulario de Registro USUARIO FEDEAV</h2>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 ps-0">
                                <ul class="list-unstyled list-group text-left text-ficha-list">
                                    ...
                                    <li>DELEGACIÓN: <span class="delegacion">"#######"</span>
